...
// UIDValidityMutation represents an operation that mutates the UIDValidity nodes in the graph.
type UIDValidityMutation struct {
	config
	op              Op
	typ             string
	id              *int
	...
	oldValue        func(context.Context) (*UIDValidity, error)
	predicates      []predicate.UIDValidity
}

var _ ent.Mutation = (*UIDValidityMutation)(nil)

// uidvalidityOption allows management of the mutation configuration using functional options.
type uidvalidityOption func(*UIDValidityMutation)

// newUIDValidityMutation creates new mutation for the UIDValidity entity.
func newUIDValidityMutation(c config, op Op, opts ...uidvalidityOption) *UIDValidityMutation {
	m := &UIDValidityMutation{
		config:        c,
		op:            op,
		typ:           TypeUIDValidity,
		clearedFields: make(map[string]struct{}),
...
// withUIDValidityID sets the ID field of the mutation.
func withUIDValidityID(id int) uidvalidityOption {
	return func(m *UIDValidityMutation) {
		var (
			err   error
			once  sync.Once
			value *UIDValidity
		)
		m.oldValue = func(ctx context.Context) (*UIDValidity, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().UIDValidity.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withUIDValidity sets the old UIDValidity of the mutation.
func withUIDValidity(node *UIDValidity) uidvalidityOption {
	return func(m *UIDValidityMutation) {
		m.oldValue = func(context.Context) (*UIDValidity, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m UIDValidityMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m UIDValidityMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *UIDValidityMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *UIDValidityMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().UIDValidity.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetUIDValidity sets the "UIDValidity" field.
func (m *UIDValidityMutation) SetUIDValidity(i imap.UID) {
	m._UIDValidity = &i
	m.add_UIDValidity = nil
}

// UIDValidity returns the value of the "UIDValidity" field in the mutation.
func (m *UIDValidityMutation) UIDValidity() (r imap.UID, exists bool) {
	v := m._UIDValidity
	if v == nil {
		return
	}
...
// OldUIDValidity returns the old "UIDValidity" field's value of the UIDValidity entity.
// If the UIDValidity object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UIDValidityMutation) OldUIDValidity(ctx context.Context) (v imap.UID, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUIDValidity is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddUIDValidity adds i to the "UIDValidity" field.
func (m *UIDValidityMutation) AddUIDValidity(i imap.UID) {
	if m.add_UIDValidity != nil {
		*m.add_UIDValidity += i
	} else {
		m.add_UIDValidity = &i
...
// AddedUIDValidity returns the value that was added to the "UIDValidity" field in this mutation.
func (m *UIDValidityMutation) AddedUIDValidity() (r imap.UID, exists bool) {
	v := m.add_UIDValidity
	if v == nil {
		return
	}
...
// ResetUIDValidity resets all changes to the "UIDValidity" field.
func (m *UIDValidityMutation) ResetUIDValidity() {
	m._UIDValidity = nil
	m.add_UIDValidity = nil
}

// Where appends a list predicates to the UIDValidityMutation builder.
func (m *UIDValidityMutation) Where(ps ...predicate.UIDValidity) {
	m.predicates = append(m.predicates, ps...)
}

// Op returns the operation name.
func (m *UIDValidityMutation) Op() Op {
	return m.op
}

// Type returns the node type of this mutation (UIDValidity).
func (m *UIDValidityMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *UIDValidityMutation) Fields() []string {
	fields := make([]string, 0, 1)
	if m._UIDValidity != nil {
		fields = append(fields, uidvalidity.FieldUIDValidity)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *UIDValidityMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *UIDValidityMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case uidvalidity.FieldUIDValidity:
		return m.OldUIDValidity(ctx)
	}
	return nil, fmt.Errorf("unknown UIDValidity field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *UIDValidityMutation) SetField(name string, value ent.Value) error {
	switch name {
	case uidvalidity.FieldUIDValidity:
		v, ok := value.(imap.UID)
		if !ok {
	...
	return fmt.Errorf("unknown UIDValidity field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *UIDValidityMutation) AddedFields() []string {
	var fields []string
	if m.add_UIDValidity != nil {
		fields = append(fields, uidvalidity.FieldUIDValidity)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *UIDValidityMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case uidvalidity.FieldUIDValidity:
		return m.AddedUIDValidity()
	}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *UIDValidityMutation) AddField(name string, value ent.Value) error {
	switch name {
	case uidvalidity.FieldUIDValidity:
		v, ok := value.(imap.UID)
		if !ok {
	...
	return fmt.Errorf("unknown UIDValidity numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *UIDValidityMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *UIDValidityMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *UIDValidityMutation) ClearField(name string) error {
	return fmt.Errorf("unknown UIDValidity nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *UIDValidityMutation) ResetField(name string) error {
	switch name {
	case uidvalidity.FieldUIDValidity:
		m.ResetUIDValidity()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *UIDValidityMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *UIDValidityMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *UIDValidityMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *UIDValidityMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *UIDValidityMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *UIDValidityMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *UIDValidityMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown UIDValidity unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *UIDValidityMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown UIDValidity edge %s", name)
}
