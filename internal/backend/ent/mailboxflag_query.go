...
func (mfq *MailboxFlagQuery) GroupBy(field string, fields ...string) *MailboxFlagGroupBy {
	group := &MailboxFlagGroupBy{config: mfq.config}
...
func (mfq *MailboxFlagQuery) Select(fields ...string) *MailboxFlagSelect {
	...
	return &MailboxFlagSelect{MailboxFlagQuery: mfq}
}
...
func (mfq *MailboxFlagQuery) sqlAll(ctx context.Context) ([]*MailboxFlag, error) {
	var (
		nodes   = []*MailboxFlag{}
		withFKs = mfq.withFKs
		_spec   = mfq.querySpec()
...
func (mfgb *MailboxFlagGroupBy) ScanX(ctx context.Context, v interface{}) {
...
func (mfgb *MailboxFlagGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(mfgb.fields) > 1 {
		return nil, errors.New("ent: MailboxFlagGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := mfgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (mfgb *MailboxFlagGroupBy) StringsX(ctx context.Context) []string {
...
// It is only allowed when executing a group-by query with one field.
func (mfgb *MailboxFlagGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{mailboxflag.Label}
	default:
		err = fmt.Errorf("ent: MailboxFlagGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (mfgb *MailboxFlagGroupBy) StringX(ctx context.Context) string {
...
// It is only allowed when executing a group-by query with one field.
func (mfgb *MailboxFlagGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(mfgb.fields) > 1 {
		return nil, errors.New("ent: MailboxFlagGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := mfgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (mfgb *MailboxFlagGroupBy) IntsX(ctx context.Context) []int {
	v, err := mfgb.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (mfgb *MailboxFlagGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{mailboxflag.Label}
	default:
		err = fmt.Errorf("ent: MailboxFlagGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (mfgb *MailboxFlagGroupBy) IntX(ctx context.Context) int {
	v, err := mfgb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (mfgb *MailboxFlagGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(mfgb.fields) > 1 {
		return nil, errors.New("ent: MailboxFlagGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := mfgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (mfgb *MailboxFlagGroupBy) Float64sX(ctx context.Context) []float64 {
...
// It is only allowed when executing a group-by query with one field.
func (mfgb *MailboxFlagGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{mailboxflag.Label}
	default:
		err = fmt.Errorf("ent: MailboxFlagGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (mfgb *MailboxFlagGroupBy) Float64X(ctx context.Context) float64 {
...
// It is only allowed when executing a group-by query with one field.
func (mfgb *MailboxFlagGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(mfgb.fields) > 1 {
		return nil, errors.New("ent: MailboxFlagGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := mfgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (mfgb *MailboxFlagGroupBy) BoolsX(ctx context.Context) []bool {
...
// It is only allowed when executing a group-by query with one field.
func (mfgb *MailboxFlagGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{mailboxflag.Label}
	default:
		err = fmt.Errorf("ent: MailboxFlagGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (mfgb *MailboxFlagGroupBy) BoolX(ctx context.Context) bool {
	v, err := mfgb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
// ScanX is like Scan, but panics if an error occurs.
func (mfs *MailboxFlagSelect) ScanX(ctx context.Context, v interface{}) {
...
func (mfs *MailboxFlagSelect) Strings(ctx context.Context) ([]string, error) {
	if len(mfs.fields) > 1 {
		return nil, errors.New("ent: MailboxFlagSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := mfs.Scan(ctx, &v); err != nil {
		return nil, err
...
// StringsX is like Strings, but panics if an error occurs.
func (mfs *MailboxFlagSelect) StringsX(ctx context.Context) []string {
...
func (mfs *MailboxFlagSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{mailboxflag.Label}
	default:
		err = fmt.Errorf("ent: MailboxFlagSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (mfs *MailboxFlagSelect) StringX(ctx context.Context) string {
...
func (mfs *MailboxFlagSelect) Ints(ctx context.Context) ([]int, error) {
	if len(mfs.fields) > 1 {
		return nil, errors.New("ent: MailboxFlagSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := mfs.Scan(ctx, &v); err != nil {
		return nil, err
...
// IntsX is like Ints, but panics if an error occurs.
func (mfs *MailboxFlagSelect) IntsX(ctx context.Context) []int {
	v, err := mfs.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
func (mfs *MailboxFlagSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{mailboxflag.Label}
	default:
		err = fmt.Errorf("ent: MailboxFlagSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (mfs *MailboxFlagSelect) IntX(ctx context.Context) int {
	v, err := mfs.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (mfs *MailboxFlagSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(mfs.fields) > 1 {
		return nil, errors.New("ent: MailboxFlagSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := mfs.Scan(ctx, &v); err != nil {
		return nil, err
...
// Float64sX is like Float64s, but panics if an error occurs.
func (mfs *MailboxFlagSelect) Float64sX(ctx context.Context) []float64 {
...
func (mfs *MailboxFlagSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{mailboxflag.Label}
	default:
		err = fmt.Errorf("ent: MailboxFlagSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (mfs *MailboxFlagSelect) Float64X(ctx context.Context) float64 {
...
func (mfs *MailboxFlagSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(mfs.fields) > 1 {
		return nil, errors.New("ent: MailboxFlagSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := mfs.Scan(ctx, &v); err != nil {
		return nil, err
...
// BoolsX is like Bools, but panics if an error occurs.
func (mfs *MailboxFlagSelect) BoolsX(ctx context.Context) []bool {
	v, err := mfs.Bools(ctx)
	if err != nil {
		panic(err)
	}
...
func (mfs *MailboxFlagSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{mailboxflag.Label}
	default:
		err = fmt.Errorf("ent: MailboxFlagSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (mfs *MailboxFlagSelect) BoolX(ctx context.Context) bool {
	v, err := mfs.Bool(ctx)
	if err != nil {
		panic(err)
	}
