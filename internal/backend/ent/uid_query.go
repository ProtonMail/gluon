...
func (uq *UIDQuery) GroupBy(field string, fields ...string) *UIDGroupBy {
	group := &UIDGroupBy{config: uq.config}
...
func (uq *UIDQuery) sqlAll(ctx context.Context) ([]*UID, error) {
	var (
		nodes       = []*UID{}
		withFKs     = uq.withFKs
		_spec       = uq.querySpec()
	...
	if query := uq.withMessage; query != nil {
		...
		for _, n := range neighbors {
			...
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "uid_message" returned %v`, n.ID)
			}
			for i := range nodes {
	...
	if query := uq.withMailbox; query != nil {
		...
		for _, n := range neighbors {
			nodes, ok := nodeids[n.ID]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "mailbox_ui_ds" returned %v`, n.ID)
			}
			for i := range nodes {
...
func (ugb *UIDGroupBy) ScanX(ctx context.Context, v interface{}) {
...
func (ugb *UIDGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("ent: UIDGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UIDGroupBy) StringsX(ctx context.Context) []string {
...
// It is only allowed when executing a group-by query with one field.
func (ugb *UIDGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{uid.Label}
	default:
		err = fmt.Errorf("ent: UIDGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (ugb *UIDGroupBy) StringX(ctx context.Context) string {
...
// It is only allowed when executing a group-by query with one field.
func (ugb *UIDGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("ent: UIDGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UIDGroupBy) IntsX(ctx context.Context) []int {
	v, err := ugb.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (ugb *UIDGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{uid.Label}
	default:
		err = fmt.Errorf("ent: UIDGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (ugb *UIDGroupBy) IntX(ctx context.Context) int {
	v, err := ugb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (ugb *UIDGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("ent: UIDGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UIDGroupBy) Float64sX(ctx context.Context) []float64 {
...
// It is only allowed when executing a group-by query with one field.
func (ugb *UIDGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{uid.Label}
	default:
		err = fmt.Errorf("ent: UIDGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (ugb *UIDGroupBy) Float64X(ctx context.Context) float64 {
...
// It is only allowed when executing a group-by query with one field.
func (ugb *UIDGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("ent: UIDGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UIDGroupBy) BoolsX(ctx context.Context) []bool {
	v, err := ugb.Bools(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (ugb *UIDGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{uid.Label}
	default:
		err = fmt.Errorf("ent: UIDGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (ugb *UIDGroupBy) BoolX(ctx context.Context) bool {
	v, err := ugb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
// ScanX is like Scan, but panics if an error occurs.
func (us *UIDSelect) ScanX(ctx context.Context, v interface{}) {
...
func (us *UIDSelect) Strings(ctx context.Context) ([]string, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("ent: UIDSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
// StringsX is like Strings, but panics if an error occurs.
func (us *UIDSelect) StringsX(ctx context.Context) []string {
...
func (us *UIDSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{uid.Label}
	default:
		err = fmt.Errorf("ent: UIDSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (us *UIDSelect) StringX(ctx context.Context) string {
	v, err := us.String(ctx)
	if err != nil {
		panic(err)
	}
...
func (us *UIDSelect) Ints(ctx context.Context) ([]int, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("ent: UIDSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
// IntsX is like Ints, but panics if an error occurs.
func (us *UIDSelect) IntsX(ctx context.Context) []int {
	v, err := us.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
func (us *UIDSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{uid.Label}
	default:
		err = fmt.Errorf("ent: UIDSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (us *UIDSelect) IntX(ctx context.Context) int {
	v, err := us.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (us *UIDSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("ent: UIDSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
// Float64sX is like Float64s, but panics if an error occurs.
func (us *UIDSelect) Float64sX(ctx context.Context) []float64 {
...
func (us *UIDSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{uid.Label}
	default:
		err = fmt.Errorf("ent: UIDSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (us *UIDSelect) Float64X(ctx context.Context) float64 {
...
func (us *UIDSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("ent: UIDSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
// BoolsX is like Bools, but panics if an error occurs.
func (us *UIDSelect) BoolsX(ctx context.Context) []bool {
	v, err := us.Bools(ctx)
	if err != nil {
		panic(err)
	}
...
func (us *UIDSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{uid.Label}
	default:
		err = fmt.Errorf("ent: UIDSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (us *UIDSelect) BoolX(ctx context.Context) bool {
	v, err := us.Bool(ctx)
	if err != nil {
		panic(err)
	}
