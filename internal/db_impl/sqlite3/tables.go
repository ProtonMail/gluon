...
type Table interface {
	Name() string
	Create(ctx context.Context, tx TXWrapper) error
}

func execQueries(ctx context.Context, tx TXWrapper, queries []string) error {
	for _, q := range queries {
		if _, err := ExecQuery(ctx, tx, q); err != nil {
			return err
		}
	}
...
func (d DeletedSubscriptionsTable) Create(ctx context.Context, tx TXWrapper) error {
	queries := []string{
...
func (m MailboxesTable) Create(ctx context.Context, tx TXWrapper) error {
	queries := []string{
...
func (m MailboxAttrTable) Create(ctx context.Context, tx TXWrapper) error {
	queries := []string{
...
func (m MailboxFlagsTable) Create(ctx context.Context, tx TXWrapper) error {
	queries := []string{
...
func (m MailboxPermFlagsTable) Create(ctx context.Context, tx TXWrapper) error {
	queries := []string{
...
func (m MessagesTable) Create(ctx context.Context, tx TXWrapper) error {
	queries := []string{
...
func (m MessageFlagsTable) Create(ctx context.Context, tx TXWrapper) error {
	queries := []string{
...
func (U UIDsTable) Create(ctx context.Context, tx TXWrapper) error {
	queries := []string{
...
func (g GluonVersionTable) Create(ctx context.Context, tx TXWrapper) error {
	queries := []string{
