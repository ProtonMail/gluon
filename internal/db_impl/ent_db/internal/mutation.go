...
// WhereP appends storage-level predicates to the DeletedSubscriptionMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *DeletedSubscriptionMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.DeletedSubscription, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
func (m *DeletedSubscriptionMutation) SetOp(op Op) {
	m.op = op
}
...
// WhereP appends storage-level predicates to the MailboxAttrMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *MailboxAttrMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.MailboxAttr, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *MailboxAttrMutation) SetOp(op Op) {
	m.op = op
}
...
// WhereP appends storage-level predicates to the MailboxFlagMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *MailboxFlagMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.MailboxFlag, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *MailboxFlagMutation) SetOp(op Op) {
	m.op = op
}
...
// WhereP appends storage-level predicates to the MailboxPermFlagMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *MailboxPermFlagMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.MailboxPermFlag, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *MailboxPermFlagMutation) SetOp(op Op) {
	m.op = op
}
...
// WhereP appends storage-level predicates to the MessageFlagMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *MessageFlagMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.MessageFlag, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *MessageFlagMutation) SetOp(op Op) {
	m.op = op
}
...
// WhereP appends storage-level predicates to the UIDMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *UIDMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.UID, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// SetOp allows setting the mutation operation.
func (m *UIDMutation) SetOp(op Op) {
	m.op = op
}
