...
func (*MailboxFlag) scanValues(columns []string) ([]any, error) {
...
func (mf *MailboxFlag) assignValues(columns []string, values []any) error {
...
func (mf *MailboxFlag) Update() *MailboxFlagUpdateOne {
	return NewMailboxFlagClient(mf.config).UpdateOne(mf)
}
