...
func (*MailboxAttr) scanValues(columns []string) ([]any, error) {
...
func (ma *MailboxAttr) assignValues(columns []string, values []any) error {
...
func (ma *MailboxAttr) Update() *MailboxAttrUpdateOne {
	return NewMailboxAttrClient(ma.config).UpdateOne(ma)
}
