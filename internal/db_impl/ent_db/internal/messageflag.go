...
func (*MessageFlag) scanValues(columns []string) ([]any, error) {
...
func (mf *MessageFlag) assignValues(columns []string, values []any) error {
...
func (mf *MessageFlag) QueryMessages() *MessageQuery {
	return NewMessageFlagClient(mf.config).QueryMessages(mf)
}
...
func (mf *MessageFlag) Update() *MessageFlagUpdateOne {
	return NewMessageFlagClient(mf.config).UpdateOne(mf)
}
