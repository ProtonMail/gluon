...
func (*DeletedSubscription) scanValues(columns []string) ([]any, error) {
...
func (ds *DeletedSubscription) assignValues(columns []string, values []any) error {
...
func (ds *DeletedSubscription) Update() *DeletedSubscriptionUpdateOne {
	return NewDeletedSubscriptionClient(ds.config).UpdateOne(ds)
}
