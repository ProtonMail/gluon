...
func (c *Client) Intercept(interceptors ...Interceptor) {
	c.DeletedSubscription.Intercept(interceptors...)
	c.Mailbox.Intercept(interceptors...)
	c.MailboxAttr.Intercept(interceptors...)
	c.MailboxFlag.Intercept(interceptors...)
	c.MailboxPermFlag.Intercept(interceptors...)
	c.Message.Intercept(interceptors...)
	c.MessageFlag.Intercept(interceptors...)
	c.UID.Intercept(interceptors...)
}

// Mutate implements the ent.Mutator interface.
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	switch m := m.(type) {
	case *DeletedSubscriptionMutation:
		return c.DeletedSubscription.mutate(ctx, m)
	case *MailboxMutation:
		return c.Mailbox.mutate(ctx, m)
	case *MailboxAttrMutation:
		return c.MailboxAttr.mutate(ctx, m)
	case *MailboxFlagMutation:
		return c.MailboxFlag.mutate(ctx, m)
	case *MailboxPermFlagMutation:
		return c.MailboxPermFlag.mutate(ctx, m)
	case *MessageMutation:
		return c.Message.mutate(ctx, m)
	case *MessageFlagMutation:
		return c.MessageFlag.mutate(ctx, m)
	case *UIDMutation:
		return c.UID.mutate(ctx, m)
	default:
...
// A call to `Intercept(f, g, h)` equals to `deletedsubscription.Intercept(f(g(h())))`.
func (c *DeletedSubscriptionClient) Intercept(interceptors ...Interceptor) {
	c.inters.DeletedSubscription = append(c.inters.DeletedSubscription, interceptors...)
}
...
func (c *DeletedSubscriptionClient) Query() *DeletedSubscriptionQuery {
	return &DeletedSubscriptionQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeDeletedSubscription},
...
func (c *DeletedSubscriptionClient) Interceptors() []Interceptor {
	return c.inters.DeletedSubscription
}

func (c *DeletedSubscriptionClient) mutate(ctx context.Context, m *DeletedSubscriptionMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&DeletedSubscriptionCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&DeletedSubscriptionUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&DeletedSubscriptionUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&DeletedSubscriptionDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("internal: unknown DeletedSubscription mutation op: %q", m.Op())
	}
}
...
func (c *MailboxClient) QueryUIDs(m *Mailbox) *UIDQuery {
	query := (&UIDClient{config: c.config}).Query()
...
func (c *MailboxClient) QueryFlags(m *Mailbox) *MailboxFlagQuery {
	query := (&MailboxFlagClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(mailbox.Table, mailbox.FieldID, id),
...
func (c *MailboxClient) QueryPermanentFlags(m *Mailbox) *MailboxPermFlagQuery {
	query := (&MailboxPermFlagClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(mailbox.Table, mailbox.FieldID, id),
...
func (c *MailboxClient) QueryAttributes(m *Mailbox) *MailboxAttrQuery {
	query := (&MailboxAttrClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(mailbox.Table, mailbox.FieldID, id),
...
func (c *MailboxClient) mutate(ctx context.Context, m *MailboxMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("internal: unknown Mailbox mutation op: %q", m.Op())
	}
}
...
// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `mailboxattr.Intercept(f(g(h())))`.
func (c *MailboxAttrClient) Intercept(interceptors ...Interceptor) {
	c.inters.MailboxAttr = append(c.inters.MailboxAttr, interceptors...)
}
...
func (c *MailboxAttrClient) Query() *MailboxAttrQuery {
	return &MailboxAttrQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeMailboxAttr},
		inters: c.Interceptors(),
	}
}
...
// Interceptors returns the client interceptors.
func (c *MailboxAttrClient) Interceptors() []Interceptor {
	return c.inters.MailboxAttr
}

func (c *MailboxAttrClient) mutate(ctx context.Context, m *MailboxAttrMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&MailboxAttrCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&MailboxAttrUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&MailboxAttrUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&MailboxAttrDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("internal: unknown MailboxAttr mutation op: %q", m.Op())
	}
}
...
// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `mailboxflag.Intercept(f(g(h())))`.
func (c *MailboxFlagClient) Intercept(interceptors ...Interceptor) {
	c.inters.MailboxFlag = append(c.inters.MailboxFlag, interceptors...)
}
...
func (c *MailboxFlagClient) Query() *MailboxFlagQuery {
	return &MailboxFlagQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeMailboxFlag},
		inters: c.Interceptors(),
	}
}
...
// Interceptors returns the client interceptors.
func (c *MailboxFlagClient) Interceptors() []Interceptor {
	return c.inters.MailboxFlag
}

func (c *MailboxFlagClient) mutate(ctx context.Context, m *MailboxFlagMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&MailboxFlagCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&MailboxFlagUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&MailboxFlagUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&MailboxFlagDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("internal: unknown MailboxFlag mutation op: %q", m.Op())
	}
}
...
// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `mailboxpermflag.Intercept(f(g(h())))`.
func (c *MailboxPermFlagClient) Intercept(interceptors ...Interceptor) {
	c.inters.MailboxPermFlag = append(c.inters.MailboxPermFlag, interceptors...)
}
...
func (c *MailboxPermFlagClient) Query() *MailboxPermFlagQuery {
	return &MailboxPermFlagQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeMailboxPermFlag},
		inters: c.Interceptors(),
	}
}
...
// Interceptors returns the client interceptors.
func (c *MailboxPermFlagClient) Interceptors() []Interceptor {
	return c.inters.MailboxPermFlag
}

func (c *MailboxPermFlagClient) mutate(ctx context.Context, m *MailboxPermFlagMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&MailboxPermFlagCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&MailboxPermFlagUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&MailboxPermFlagUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&MailboxPermFlagDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("internal: unknown MailboxPermFlag mutation op: %q", m.Op())
	}
}
...
func (c *MessageClient) QueryFlags(m *Message) *MessageFlagQuery {
	query := (&MessageFlagClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
...
// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `messageflag.Intercept(f(g(h())))`.
func (c *MessageFlagClient) Intercept(interceptors ...Interceptor) {
	c.inters.MessageFlag = append(c.inters.MessageFlag, interceptors...)
}
...
func (c *MessageFlagClient) Query() *MessageFlagQuery {
	return &MessageFlagQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeMessageFlag},
		inters: c.Interceptors(),
	}
}
...
// Interceptors returns the client interceptors.
func (c *MessageFlagClient) Interceptors() []Interceptor {
	return c.inters.MessageFlag
}

func (c *MessageFlagClient) mutate(ctx context.Context, m *MessageFlagMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&MessageFlagCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&MessageFlagUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&MessageFlagUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&MessageFlagDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("internal: unknown MessageFlag mutation op: %q", m.Op())
	}
}
...
// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `uid.Intercept(f(g(h())))`.
func (c *UIDClient) Intercept(interceptors ...Interceptor) {
	c.inters.UID = append(c.inters.UID, interceptors...)
}
...
// Interceptors returns the client interceptors.
func (c *UIDClient) Interceptors() []Interceptor {
	return c.inters.UID
}

func (c *UIDClient) mutate(ctx context.Context, m *UIDMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&UIDCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&UIDUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&UIDUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&UIDDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("internal: unknown UID mutation op: %q", m.Op())
	}
}
