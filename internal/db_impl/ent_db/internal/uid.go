...
func (*UID) scanValues(columns []string) ([]any, error) {
...
// to the UID fields.
func (u *UID) assignValues(columns []string, values []any) error {
...
func (u *UID) Update() *UIDUpdateOne {
	return NewUIDClient(u.config).UpdateOne(u)
}
