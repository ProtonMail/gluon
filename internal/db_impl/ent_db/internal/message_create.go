...
func (mc *MessageCreate) check() error {
	if _, ok := mc.mutation.Date(); !ok {
		return &ValidationError{Name: "Date", err: errors.New(`internal: missing required field "Message.Date"`)}
	}
	if _, ok := mc.mutation.Size(); !ok {
		return &ValidationError{Name: "Size", err: errors.New(`internal: missing required field "Message.Size"`)}
	}
	...
	if _, ok := mc.mutation.BodyStructure(); !ok {
		return &ValidationError{Name: "BodyStructure", err: errors.New(`internal: missing required field "Message.BodyStructure"`)}
	}
	if _, ok := mc.mutation.Envelope(); !ok {
		return &ValidationError{Name: "Envelope", err: errors.New(`internal: missing required field "Message.Envelope"`)}
	}
	if _, ok := mc.mutation.Deleted(); !ok {
		return &ValidationError{Name: "Deleted", err: errors.New(`internal: missing required field "Message.Deleted"`)}
	}
	return nil
}
