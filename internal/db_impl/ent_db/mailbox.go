...
func MailboxExistsWithID(ctx context.Context, client *internal.Client, mboxID imap.InternalMailboxID) (bool, error) {
	return client.Mailbox.Query().Where(mailbox.ID(mboxID)).Exist(ctx)
}

func MailboxExistsWithRemoteID(ctx context.Context, client *internal.Client, mboxID imap.MailboxID) (bool, error) {
	return client.Mailbox.Query().Where(mailbox.RemoteID(mboxID)).Exist(ctx)
}

func GetMailboxIDFromRemoteID(ctx context.Context, client *internal.Client, mboxID imap.MailboxID) (imap.InternalMailboxID, error) {
...
func MailboxExistsWithName(ctx context.Context, client *internal.Client, name string) (bool, error) {
	return client.Mailbox.Query().Where(mailbox.Name(name)).Exist(ctx)
}

func RenameMailboxWithRemoteID(ctx context.Context, tx *internal.Tx, mboxID imap.MailboxID, name string) error {
...
func UpdateRemoteMailboxID(ctx context.Context, tx *internal.Tx, internalID imap.InternalMailboxID, remoteID imap.MailboxID) error {
	if _, err := tx.Mailbox.Update().
...
func BumpMailboxUIDNext(ctx context.Context, tx *internal.Tx, mbox *internal.Mailbox, withCount ...int) error {
	var n int
...
func GetMailboxName(ctx context.Context, client *internal.Client, mboxID imap.InternalMailboxID) (string, error) {
...
func GetMailboxNameWithRemoteID(ctx context.Context, client *internal.Client, mboxID imap.MailboxID) (string, error) {
...
func GetMailboxMessageIDPairs(ctx context.Context, client *internal.Client, mailboxID imap.InternalMailboxID) ([]db.MessageIDPair, error) {
	...
	return xslices.Map(messages, func(message *internal.Message) db.MessageIDPair {
...
func GetAllMailboxes(ctx context.Context, client *internal.Client) ([]*internal.Mailbox, error) {
	const QueryLimit = 16000

	var mailboxes []*internal.Mailbox
...
func GetMailboxByName(ctx context.Context, client *internal.Client, name string) (*internal.Mailbox, error) {
	return client.Mailbox.Query().Where(mailbox.Name(name)).Only(ctx)
}

func GetMailboxByID(ctx context.Context, client *internal.Client, id imap.InternalMailboxID) (*internal.Mailbox, error) {
	return client.Mailbox.Query().Where(mailbox.ID(id)).Only(ctx)
}

func GetMailboxByRemoteID(ctx context.Context, client *internal.Client, id imap.MailboxID) (*internal.Mailbox, error) {
	return client.Mailbox.Query().Where(mailbox.RemoteID(id)).Only(ctx)
}

func GetMailboxRecentCount(ctx context.Context, client *internal.Client, mbox *internal.Mailbox) (int, error) {
	return mbox.QueryUIDs().Where(uid.Recent(true)).Count(ctx)
}

func GetMailboxMessageCount(ctx context.Context, client *internal.Client, mboxID imap.InternalMailboxID) (int, error) {
	return client.UID.Query().Where(func(s *sql.Selector) {
		s.Where(sql.EQ(uid.MailboxColumn, mboxID))
	}).Count(ctx)
}

func GetMailboxMessagesForNewSnapshot(ctx context.Context, client *internal.Client, mboxID imap.InternalMailboxID) ([]db.SnapshotMessageResult, error) {
	messages := make([]db.SnapshotMessageResult, 0, 32)
...
func GetMailboxIDWithRemoteID(ctx context.Context, client *internal.Client, mboxID imap.MailboxID) (imap.InternalMailboxID, error) {
	mbox, err := client.Mailbox.Query().Where(mailbox.RemoteID(mboxID)).Select(mailbox.FieldID).Only(ctx)
	if err != nil {
		return 0, err
	}
...
func TranslateRemoteMailboxIDs(ctx context.Context, client *internal.Client, mboxIDs []imap.MailboxID) ([]imap.InternalMailboxID, error) {
	mboxes, err := client.Mailbox.Query().Where(mailbox.RemoteIDIn(mboxIDs...)).Select(mailbox.FieldID).All(ctx)
	if err != nil {
		return nil, err
	}

	return xslices.Map(mboxes, func(m *internal.Mailbox) imap.InternalMailboxID {
		return m.ID
	}), nil
}

func CreateMailboxIfNotExists(ctx context.Context, tx *internal.Tx, mbox imap.Mailbox, delimiter string, uidValidity imap.UID) error {
...
func GetOrCreateMailbox(ctx context.Context, tx *internal.Tx, mbox imap.Mailbox, delimiter string, uidValidity imap.UID) (*internal.Mailbox, error) {
...
func FilterMailboxContains(ctx context.Context, client *internal.Client, mboxID imap.InternalMailboxID, messageIDs []db.MessageIDPair) ([]imap.InternalMessageID, error) {
	type result struct {
	...
	if err := client.UID.Query().Where(func(s *sql.Selector) {
		s.Where(sql.And(sql.EQ(uid.MailboxColumn, mboxID), sql.In(uid.MessageColumn, xslices.Map(messageIDs, func(id db.MessageIDPair) interface{} {
...
func FilterMailboxContainsInternalID(ctx context.Context, client *internal.Client, mboxID imap.InternalMailboxID, messageIDs []imap.InternalMessageID) ([]imap.InternalMessageID, error) {
	type result struct {
		InternalID imap.InternalMessageID `json:"uid_message"`
	}
...
func GetMailboxFlags(ctx context.Context, client *internal.Client, mboxID imap.InternalMailboxID) (imap.FlagSet, error) {
	mbox, err := client.Mailbox.Query().Where(mailbox.ID(mboxID)).WithFlags().Only(ctx)
	if err != nil {
		return imap.FlagSet{}, err
	}

	return imap.NewFlagSetFromSlice(xslices.Map(mbox.Edges.Flags, func(flag *internal.MailboxFlag) string {
		return flag.Value
	})), nil
}

func GetMailboxPermanentFlags(ctx context.Context, client *internal.Client, mboxID imap.InternalMailboxID) (imap.FlagSet, error) {
	mbox, err := client.Mailbox.Query().Where(mailbox.ID(mboxID)).WithPermanentFlags().Only(ctx)
	if err != nil {
		return imap.FlagSet{}, err
	}

	return imap.NewFlagSetFromSlice(xslices.Map(mbox.Edges.PermanentFlags, func(flag *internal.MailboxPermFlag) string {
		return flag.Value
	})), nil
}

func GetMailboxAttributes(ctx context.Context, client *internal.Client, mboxID imap.InternalMailboxID) (imap.FlagSet, error) {
	mbox, err := client.Mailbox.Query().Where(mailbox.ID(mboxID)).WithAttributes().Only(ctx)
	if err != nil {
		return imap.FlagSet{}, err
	}

	return imap.NewFlagSetFromSlice(xslices.Map(mbox.Edges.Attributes, func(flag *internal.MailboxAttr) string {
		return flag.Value
	})), nil
}

func IsMessageInMailbox(ctx context.Context, client *internal.Client, mboxID imap.InternalMailboxID, messageID imap.InternalMailboxID) (bool, error) {
	return client.UID.Query().Where(func(s *sql.Selector) {
...
func GetMailboxCount(ctx context.Context, client *internal.Client) (int, error) {
	return client.Mailbox.Query().Count(ctx)
}

func GetMailboxUID(ctx context.Context, client *internal.Client, mboxID imap.InternalMailboxID) (imap.UID, error) {
...
func GetMailboxMessageCountAndUID(ctx context.Context, client *internal.Client, mboxID imap.InternalMailboxID) (int, imap.UID, error) {
