...
func TestLoadSaveOps(t *testing.T) {
	...
	data.PendingOps = []operation{
		&OpMailboxCreate{OperationBase: OperationBase{MetadataID: ConnMetadataID(204)}, InternalID: "tempID", Name: []string{"name"}},
		...
		&OpMessageAdd{OperationBase: OperationBase{MetadataID: ConnMetadataID(6)}, MessageIDs: []imap.MessageID{"messageID1", "messageID2"}, MBoxID: "mboxID"},
		&OpMessageRemove{OperationBase: OperationBase{MetadataID: ConnMetadataID(7)}, MessageIDs: []imap.MessageID{"messageID1", "messageID2"}, MBoxID: "mboxID"},
		&OpMessageSeen{OperationBase: OperationBase{MetadataID: ConnMetadataID(8)}, MessageIDs: []imap.MessageID{"messageID1", "messageID2"}},
		&OpMessageFlagged{OperationBase: OperationBase{MetadataID: ConnMetadataID(9)}, MessageIDs: []imap.MessageID{"messageID1", "messageID2"}},
