...
// Source: github.com/ProtonMail/gluon/remote (interfaces: Connector)
...
func (m *MockConnector) CreateLabel(arg0 context.Context, arg1 []string, arg2 bool) (imap.Mailbox, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateLabel", arg0, arg1, arg2)
...
func (mr *MockConnectorMockRecorder) CreateLabel(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateLabel", reflect.TypeOf((*MockConnector)(nil).CreateLabel), arg0, arg1, arg2)
}
...
func (m *MockConnector) ValidateCreate(arg0 []string) (bool, imap.FlagSet, imap.FlagSet, imap.FlagSet, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidateCreate", arg0)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(imap.FlagSet)
	ret2, _ := ret[2].(imap.FlagSet)
	ret3, _ := ret[3].(imap.FlagSet)
	ret4, _ := ret[4].(error)
